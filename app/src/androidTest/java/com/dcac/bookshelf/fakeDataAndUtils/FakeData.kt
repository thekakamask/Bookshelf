...
object FakeData {
    ...
    val fakeInitialSuccessBookshelfUiState = BookshelfUiState.Success(
        userGoogleKeyWord = "",
        booksList = emptyList()
    )

    val fakeGridSuccessBookshelfUiState = BookshelfUiState.Success(
        userGoogleKeyWord = "Jazz",
        booksList = fakeDataBook
    )

    val fakeDetailsSuccessBookshelfUiState = BookshelfUiState.Success(
        userGoogleKeyWord = "Jazz",
        booksList = fakeDataBook,
        isShowingDetailsBook = true,
        currentBook = fakeDataBook[0]
    )
